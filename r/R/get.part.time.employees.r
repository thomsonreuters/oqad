...
get.part.time.employees  <-	function(dates,seccodes,quarterly=TRUE, most.recent=TRUE){
	return(get.info.from.rkd(dates, seccodes, "Part-Time Employees", quarterly, most.recent))
}
