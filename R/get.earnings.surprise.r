...
#' @author Sameena Shah 
#' @param dates dates for which earnings surprise is needed
#' @param seccodes seccodes for which earnings surprise is needed 
#' @return matrix with missing vals as NA 
#' @export
