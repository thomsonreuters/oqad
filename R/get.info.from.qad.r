...
#' @param dates Either dates or start.date and end.date
#' @param seccodes Allow seccodes to be all, one, or a list
#' @param query string 
#' @param result.column string
#' @param date.column string
#' @param seccode.column string 
#' @param per.seccode numeric 
#' @return matrix 
#' @author Ian MacGillivray and Sameena Shah
