...
#' @export
get.tier.1.capital.percentage  <-	function(dates,seccodes,quarterly=TRUE, most.recent=TRUE){
	return(get.info.from.rkd(dates, seccodes, "Tier 1 Capital %", quarterly, most.recent))
}
