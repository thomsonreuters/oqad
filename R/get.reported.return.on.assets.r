...
#' @export
get.reported.return.on.assets  <-	function(dates,seccodes,quarterly=TRUE, most.recent=TRUE){
	return(get.info.from.rkd(dates, seccodes, "Reported Return On Assets", quarterly, most.recent))
}
