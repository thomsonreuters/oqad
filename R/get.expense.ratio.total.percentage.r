...
#' @return matrix 
#' @export
get.expense.ratio.total.percentage  <-	function(dates,seccodes,quarterly=TRUE, most.recent=TRUE){
	return(get.info.from.rkd(dates, seccodes, "Expense Ratio, Total -%", quarterly, most.recent))
}
